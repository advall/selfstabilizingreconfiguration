"""
Tests that the system recovers from a stale information of type 1.

This is done by launching the system and letting it run for 10 seconds, before
injecting an invalid notification at one of the nodes which should trigger a
brute force reconfiguration.
"""
...
class TestStaleInformationType1(AbstractIntegrationTest):
    ...
    async def inject_stale_info(self):
        ...
        await helpers.POST(0, "/inject_prp", data={ "phase": 0, "set": [1,2,3] })
